...
M.smart_splits = {
  { '<C-h>', snacks_smart_move('h', 'move_cursor_left'), mode = { 'n' }, desc = 'Move cursor left' },
  { '<C-j>', snacks_smart_move('j', 'move_cursor_down'), mode = { 'n' }, desc = 'Move cursor down' },
  { '<C-k>', snacks_smart_move('k', 'move_cursor_up'), mode = { 'n' }, desc = 'Move cursor up' },
  { '<C-l>', snacks_smart_move('l', 'move_cursor_right'), mode = { 'n' }, desc = 'Move cursor right' },
}
